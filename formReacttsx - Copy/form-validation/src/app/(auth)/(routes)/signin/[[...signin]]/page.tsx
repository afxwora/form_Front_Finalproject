...
const signInSchema = z.object({
    name: z.string().min(5, "Username Should have atleast 2 characters.").max(10, "Usernme should not exceed 50 characters.").refine((value) => /^[a-zA-Z]+[-'s]?[a-zA-Z ]+$/.test(value), 'Username should contain only alphabets.'),
